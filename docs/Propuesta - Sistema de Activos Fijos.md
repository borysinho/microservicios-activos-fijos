...
El sistema propuesto es una plataforma distribuida para la **gestión integral de activos fijos** de una organización. Permite registrar, asignar, trasladar, depreciar y dar de baja activos físicos, integrando inteligencia artificial para diagnóstico de estado, gestión documental con auditoría, automatización de procesos y analítica de negocios.
...
System_Boundary(saf, "Sistema de Activos Fijos") {
    ...
    Container_Boundary(azure_ms, "MS1 — Azure") {
        ...
        ContainerDb(pg, "PostgreSQL", "Base de datos relacional", "Activos, asignaciones, depreciación")
    }
...
Rel(mobile, ms2, "Sube foto, recibe diagnóstico IA", "REST / HTTPS")
...
- Deep Learning: diagnóstico del estado físico de activos por imagen
...
#### Flujo de Diagnóstico de Activo por Imagen
...
| ------------------------ | ----------------------------------------------------------------------------- |
| **Cámara**               | Fotografiar activos para diagnóstico automático de estado (Deep Learning)     |
...
La app permite tomar una foto de un activo y recibir en tiempo real un diagnóstico generado por el modelo CNN del MS2:
...
rectangle "App Móvil React Native" {
    ...
    usecase "Ver detalle\nde activo" as UC2
    usecase "Fotografiar activo\ny obtener diagnóstico IA" as UC3
...
| Diagnóstico crítico   | Hash de imagen, resultado IA, fecha |
...
- Resultados históricos de diagnósticos IA
...
| 3 proveedores cloud            | Azure (MS1), AWS (MS2), Google Cloud (MS3)                    |
...
| Deep Learning                  | CNN para diagnóstico de estado físico por imagen              |
