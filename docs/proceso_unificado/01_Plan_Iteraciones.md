...
- [x] `ActivoResolver` — todas las queries y mutations del schema
- [x] `AsignacionResolver` — asignar, devolver, consultar
- [x] `TrasladoResolver` — registrar, autorizar, confirmar recepción
- [x] `BajaResolver` — registrar baja, autorizar
- [x] Catálogos en `CatalogoResolver` — categorías, áreas, responsables y usuarios con CRUD/roles
- [x] Integración Blockchain en cada mutación de estado del activo
- [x] `ReporteResolver` — `reporteDepreciacion` + `historialBlockchain`

### CUs a completar en IT-C1

**Módulo 1 — Gestión de Activos** (MS1)

- [x] CU-01: Registrar nuevo activo fijo
- [x] CU-02: Editar datos del activo
- [x] CU-03: Consultar catálogo de activos
- [x] CU-04: Buscar activo por código, nombre o categoría
- [x] CU-05: Cambiar estado del activo
- [x] CU-06: Registrar categoría de activo
- [x] CU-07: Editar categoría de activo
- [x] CU-08: Consultar historial completo de movimientos del activo
- [x] CU-09: Ver ficha detallada del activo con valor en libros actual

**Módulo 2 — Asignaciones y Traslados** (MS1)

- [x] CU-10: Asignar activo a responsable de área
- [x] CU-11: Devolver activo al inventario
- [x] CU-12: Registrar traslado entre áreas
- [x] CU-13: Autorizar traslado
- [x] CU-14: Consultar activos asignados por área
- [x] CU-15: Consultar historial de asignaciones
- [x] CU-16: Consultar historial de traslados
- [x] CU-17: Reporte de activos por responsable

**Módulo 3 — Depreciación y Bajas** (MS1)

- [x] CU-18: Calcular depreciación del activo
- [x] CU-19: Reporte de depreciación anual
- [x] CU-20: Consultar valor en libros actual
- [x] CU-21: Proyectar vida útil restante
- [x] CU-22: Registrar baja de activo
- [x] CU-23: Autorizar baja de activo
- [x] CU-24: Historial de activos dados de baja
- [x] CU-25: Generar acta de baja en PDF

**Módulo 7 — Gestión de Usuarios** (MS1)

- [x] CU-46: Registrar nuevo usuario
- [x] CU-47: Editar datos del usuario
- [x] CU-48: Asignar o cambiar rol
- [x] CU-49: Inactivar usuario
- [x] CU-50: Restablecer contraseña
- [x] CU-51: Registrar área organizacional
- [x] CU-52: Asignar responsable a área
- [x] CU-53: Buscar usuario

**Módulo 11 — Blockchain** (MS1 — automático en mutaciones)

- [x] CU-75: Registro en Blockchain al registrar activo
- [x] CU-76: Registro en Blockchain al asignar activo
- [x] CU-77: Registro en Blockchain al trasladar activo
- [x] CU-78: Registro en Blockchain al dar de baja
- [x] CU-79: Registro en Blockchain al diagnóstico crítico de IA
- [x] CU-80: Consultar historial Blockchain de un activo
- [x] CU-81: Verificar integridad de registro Blockchain

### Frontend a completar en IT-C1

- [x] Página: Catálogo de activos con filtros y búsqueda
- [x] Formulario: Registro y edición de activo
- [x] Ficha de activo: detalle + historial + valor en libros
- [x] Página: Asignaciones (asignar, devolver)
- [x] Página: Traslados (registrar, autorizar, confirmar)
- [x] Página: Bajas (registrar, autorizar, historial)
- [x] Página: Categorías de activo (CRUD)
- [x] Página: Áreas y responsables (CRUD)
- [x] Página: Gestión de usuarios con roles
- [x] Página: Historial Blockchain de activo

### Criterios de éxito IT-C1

- [x] Se puede registrar un activo completo y verlo en el catálogo
- [x] Se puede asignar, trasladar y dar de baja un activo
- [x] Cada mutación de estado genera un `RegistroBlockchain` verificable
- [x] El reporte de depreciación muestra valores correctos por los 3 métodos
- [x] El dashboard BI (`dashboardBI`) muestra datos reales de la BD
- [x] Se puede gestionar usuarios con distintos roles y los permisos funcionan
...
- [x] `DiagnosticoIAService` — orquesta la verificación visual de evidencia
- [x] `ModelLoader` — carga y gestiona los modelos entrenados
- [x] `CNN_VerificacionVisual` — modelo TensorFlow/Keras como señal auxiliar
  - Resultados finales: `EVIDENCIA_VALIDADA`, `REQUIERE_REVISION`, `FOTO_NO_CONFIABLE`, `POSIBLE_INCONSISTENCIA`
  - Input: imagen 224×224 RGB
  - Output: `{ diagnostico, confianza, detalle, verificaciones }`
- [x] Persistencia de la verificación en DynamoDB + imagen en S3
...
- [x] CU-35: Enviar imagen al MS2 para verificación IA (endpoint)
- [x] CU-36: Procesar imagen y retornar evidencia/alerta auditable
...
Implementar la aplicación móvil completa para el Responsable de Área, con cámara, GPS, modo offline y verificación IA.
...
- [x] `ResultadoDiagnosticoScreen` — resultado de verificación IA
...
- [x] CU-38: Consultar historial de verificaciones anteriores
...
- [ ] MS1 → Supabase PostgreSQL configurado
...
| IA en móvil                    | Demo: foto → verificación IA en tiempo real          |
...
| BD Relacional (PostgreSQL)     | MS1 conectado a Supabase PostgreSQL                  |
