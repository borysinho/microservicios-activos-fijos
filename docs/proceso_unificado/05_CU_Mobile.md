...
**Componente**: App Móvil — Campo y Verificación IA
...
## Módulo 5 — Verificación IA en Campo
...
1. El responsable selecciona un activo y toca "Fotografiar para verificación".
...
### CU-37: Enviar imagen a MS2 y mostrar resultado de verificación

**Actor**: Responsable de Área
**Precondiciones**: La imagen fue capturada (CU-34). El dispositivo tiene conexión.
**Postcondiciones**: La verificación visual IA es recibida y mostrada en pantalla. El resultado se guarda en el historial.
...
3. MS2 valida calidad de foto, presencia visual y similitud histórica si existe.
4. La app muestra el resultado:
   - Resultado: `EVIDENCIA_VALIDADA`, `REQUIERE_REVISION`, `FOTO_NO_CONFIABLE` o `POSIBLE_INCONSISTENCIA`
   - Porcentaje de confianza
   - Detalle de verificaciones realizadas
5. Si el resultado es `POSIBLE_INCONSISTENCIA`: mostrar alerta y botón "Solicitar mantenimiento/revisión".
6. La app guarda el resultado en `AsyncStorage` (historial local).

**Alternativas**:

- 2a. Sin conexión: mostrar error "Sin conexión. La verificación requiere internet".
...
### CU-38: Consultar historial de verificaciones de un activo
...
- También mostrar verificaciones guardadas en `AsyncStorage` si existen
- Ordenar por fecha descendente

---

### CU-39: Solicitar orden de mantenimiento desde la verificación

**Actor**: Responsable de Área
**Precondiciones**: La verificación indica `POSIBLE_INCONSISTENCIA` o `REQUIERE_REVISION`.
...
2. La app abre un formulario con observaciones precompletadas con el resultado de verificación.
