...
|  **Base de Datos Relacional**  |               PostgreSQL               |          MS1 — activos, asignaciones, depreciación           |
...
- **Proveedor Cloud:** Microsoft Azure (Azure App Service + Azure PostgreSQL Flexible Server)
...
- **Funcionalidades Clave:** Consulta de activos asignados al área, fotografía de activos con diagnóstico IA en tiempo real, geolocalización de activos mediante GPS, reporte de problemas o solicitud de revisión, trabajo offline con caché local de activos, recepción de notificaciones push.

## 4.7 Infraestructura y Despliegue

- **Contenedores:** Docker (todos los servicios)
- **Proveedores:** Microsoft Azure (MS1) — Amazon Web Services (MS2) — Google Cloud Platform (MS3)
...
- CU-38: Consultar historial de diagnósticos anteriores del activo
...
| BD Relacional (PostgreSQL)      | MS1: activos, asignaciones, traslados, depreciación                   |
| BD NoSQL (DynamoDB)             | MS2: metadatos de documentos y auditoría                              |
| Almacenamiento de archivos (S3) | MS2: PDF, imágenes, contratos, actas                                  |
| Despliegue 100% cloud           | Azure + AWS + Google Cloud con Docker                                 |
| Metodología                     | Proceso Unificado                                                     |
